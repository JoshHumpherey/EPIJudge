...
def generate_all_binary_trees(num_nodes):
    ...
    for left_nodes in range(num_nodes):
        ...
        left_subtrees = generate_all_binary_trees(left_nodes)
        right_subtrees = generate_all_binary_trees(right_nodes)
...
def generate_all_binary_trees_pythonic(num_nodes):
    return [
        ...
        for left_nodes in range(num_nodes)
        for left in generate_all_binary_trees(left_nodes) for right in
        generate_all_binary_trees(num_nodes - 1 - left_nodes)
    ] or [None]
